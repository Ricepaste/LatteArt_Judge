...
class SET_SSL_Trainer:
    def __init__(
        ...
        print("Initialized SET-SSL Model.")
    ...
    def train(
        ...
        for epoch in range(num_epochs):
            ...
            if current_grow_ratio > 0.001:
                ...
                self.model.update_topology(grow_ratio=current_grow_ratio)
    ...
    def save_model(self, model, type="last", filename_prefix="SET_SSL_", directory="./runs"):
