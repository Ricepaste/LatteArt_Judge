# main/run_positive_hebb_ablation.py
import os
import subprocess
import time
import glob
...
def main():
    ...
    log_file = os.path.join(log_dir, f"positive_hebb_c100_99_seed{run_seed}.log")
    ...
    print("=" * 60)
    print("🚀 Starting Positive Hebbian Ablation Pretraining on CIFAR-100")
    print(f"Sparsity: 99% | Epochs: {num_epochs} | Seed: {run_seed}")
    ...
    try:
        with open(log_file, "w") as f:
            f.write("=== PRETRAINING STAGE (POSITIVE HEBBIAN ONLY) ===\n")
